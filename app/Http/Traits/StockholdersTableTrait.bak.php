...
trait StockholdersTableTrait
{
    public function table($stockholders, $maxPriority)
    {
        ...
        foreach ($stockholders as $stockholder) {
            $upButton = ($stockholder->priority > 1) ? '' : 'disabled';
            $downButton = ($stockholder->priority < $maxPriority) ? '' : 'disabled';
            $html .= "
            <tr>
                <td>
                    ...
                    <div class='btn-group ml-2'>
                        <button type='button'
                            class='btn btn-sm btn-default priority-up $upButton'
                        ...
                        <button type='button'
                            class='btn btn-sm btn-default priority-down $downButton'
                            data-user_id='$stockholder->id'
                            data-round_id='$stockholder->round_id'>
                ...
                <td>
                    ...
                    <div class='btn-group float-right'>
                        ...
                        <button class='btn btn-sm btn-default' type='submit'
                            form='stockholder-delete-$stockholder->id'
                    ...
                    <form id='stockholder-delete-$stockholder->id'
                        action='" . route('stockholders.destroy', $stockholder->id) . "'
                        method='POST'>
                        @csrf
                        @method('DELETE')
                    </form>
