...
--
-- Host: db
-- Generation Time: Jan 22, 2023 at 01:03 AM
...
CREATE TABLE `rounds` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `start_wishes_date` date NOT NULL DEFAULT '2023-01-22',
...
CREATE TABLE `wishes` (
  ...
  `priority` int NOT NULL DEFAULT '0',
  `status` enum('confirmed','waiting','failed','overlimit_confirmed','overlimit_failed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'waiting',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `round_user`
  ADD CONSTRAINT `round_user_round_id_foreign` FOREIGN KEY (`round_id`) REFERENCES `rounds` (`id`),
  ADD CONSTRAINT `round_user_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users_bak` (`id`);
...
ALTER TABLE `wishes`
  ...
  ADD CONSTRAINT `wishes_round_id_foreign` FOREIGN KEY (`round_id`) REFERENCES `rounds` (`id`),
  ADD CONSTRAINT `wishes_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users_bak` (`id`);
COMMIT;
